...
8. [Platform Extensions](docs/reference/platform-extensions.md)
9. [共享数据模型](docs/reference/data-models.md)
10. [交互时序图](docs/guides/interaction-sequences.md)
11. [HITL 交互指南](docs/guides/hitl.md)
12. [接入用例](docs/guides/use-cases.md)
13. [资源导航](docs/guides/resources.md)
...
| [`docs/reference/`](docs/reference/http-api.md) | 正式协议定义：核心 HTTP、SSE、WebSocket、平台扩展、数据模型 |
| [`docs/guides/`](docs/guides/interaction-sequences.md) | 时序图、HITL 指南、接入用例、资源导航 |
